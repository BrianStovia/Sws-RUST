...
pkill -f vpn-telegram-bot &>/dev/null
pkill -f vpn_telegram_bot &>/dev/null
...
files=(
    ...
    "/usr/bin/noobzvpns"
    "/usr/bin/vpn-telegram-bot"
    "/usr/local/sbin/vpn-telegram-bot"
    "/usr/local/sbin/change-reality-sni"
    "/usr/bin/change-reality-sni"
    "/usr/bin/ssh-limit"
